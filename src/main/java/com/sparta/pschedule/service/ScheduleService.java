...
import com.sparta.pschedule.dto.GetScheduleResponse;
import com.sparta.pschedule.dto.PostScheduleRequest;
import com.sparta.pschedule.dto.PostScheduleResponse;
import com.sparta.pschedule.dto.UpdateScheduleResponse;
...
public class ScheduleService {
     ...
     * Controller : get___(), post___(), put___(), delete___()
    ...
    @Transactional
    public UpdateScheduleResponse update(Long id, PostScheduleRequest request) {
        // db에 접근했다.
        Schedule response = repository.findById(id).orElseThrow(
                () -> new IllegalStateException("잘못된 id입니다.")
        );
